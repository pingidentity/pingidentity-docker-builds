...
die_on_error 12 "Error running hook 12-before-applying-server-profile.sh"

run_if present "${HOOKS_DIR}/14-get-remote-server-profile.sh"
die_on_error 14 "Error running hook 14-get-remote-server-profile.sh"

run_if present "${HOOKS_DIR}/16-apply-server-profile.sh"
die_on_error 16 "Error running hook 16-apply-server-profile.sh"
...
die_on_error 18 "Error running hook 18-setup-sequence.sh"
